package com.arrayprolc.trails.particlelib;
...
import com.arrayprolc.trails.particlelib.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center) throws IllegalArgumentException {
		display(offsetX, offsetY, offsetZ, speed, amount, center, 32);
	}
	...
	public void display(Location center, float offsetX, float offsetY, float offsetZ, float speed, int amount) throws IllegalArgumentException {
		display(offsetX, offsetY, offsetZ, speed, amount, center);
	}
	
	public void display(Location center, float offsetX, float offsetY, float offsetZ, float speed, int amount, Player... players) throws IllegalArgumentException {
		display(offsetX, offsetY, offsetZ, speed, amount, center, players);
	}
